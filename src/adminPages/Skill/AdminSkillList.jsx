...
function AdminSkillList() {
  ...
  // ✅ 6) 스킬 이미지 (Cloudinary URL 우선)
  const getSkillImage = (skill) => {
    if (skill.imageUrl) {
      return skill.imageUrl;
    }
    return "https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTEyMTZfNDAg%2FMDAxNjM5NjQxNzUxMDc5.8Z45VaLbczbt6T0CnwI5852sOiWcu9zqPby1vdSSVJ0g.wFZHYWgSfK9TsAXqEPG71DPVaz1USCDCw0aImGSBhAcg.PNG.glory8743%2F1231312.png&type=sc960_832"; // 기본 이미지
  };
